...
public class Intro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sharedPreferences.getBoolean(Constants.SP_IS_FIRST_TIME_LAUNCH, true)) {
            launchHomeScreen();
            finish();
        }
        ...
        layouts = new int[]{
                ...
                R.layout.activity_intro_three,
                R.layout.activity_intro_four
        };
    ...
    private void launchHomeScreen() {
        ...
        editor.putBoolean(Constants.SP_IS_FIRST_TIME_LAUNCH, false);
        editor.apply();
